...
class ArchivedProblems extends Component {
    static navigationOptions = ({ navigation }) => {
        return {
            title: navigation.getParam('title', 'Archived')
        };
    };
    ...
    componentWillMount() {
        ...
        this.props.navigation.setParams({ title: txt.archivedReports.pageTitle });
    }
...
export default connect(mapStateToProps)(ArchivedProblems);
